...
export const markers = [
  ...
  { station: 5, number: "", name: "CONTATO", className: "marker-return", bulge: [-1, 0.2] },
] as const;
...
export const trials = [
  {
    ...
    description:
      "Direção criativa e acabamento cinema-grade transformam sua marca no nome que o mercado cita.",
    noteTitle: "PIPELINE",
    noteLines: ["ROTEIRO · CAPTAÇÃO · PÓS", "CINEMA-GRADE — 16:9 · 9:16"],
    href: "/portfolio",
    cta: "VER PORTFÓLIO",
    theme: "paper",
  },
  {
    ...
    name: "WEB",
    focus: "CONVERSÃO",
    title: "De vitrine a máquina.",
    before: "site que só enfeita",
    after: "página que vende sozinha",
    description:
      "O vídeo abre a porta; a página fecha o negócio. Performance e UX no mesmo padrão do que filmamos.",
    noteTitle: "STACK",
    noteLines: ["DISCOVERY · DESIGN · BUILD", "MEDIDO, NÃO PROMETIDO"],
    href: "/websites",
    cta: "VER WEBSITES",
    theme: "paper",
  },
  {
    ...
    name: "SYSTEMS",
    focus: "ESCALA",
    title: "De refém a dono.",
    before: "operação presa em planilhas",
    after: "sistema que escala sem você",
    description: "Do micro-SaaS ao ERP: software sob medida, do conceito ao deploy.",
    noteTitle: "CORE",
    noteLines: ["AUTH · BILLING · DADOS", "SOB MEDIDA — SEM LICENÇAS"],
    href: "/sistemas",
    cta: "VER SISTEMAS",
    theme: "dark",
  },
...
export const importantProjects = [
  "Krrom Construtora",
  "Laticínios Latco",
  "Salles Nogueira Advogados",
  "Kofar Metalúrgica",
] as const;
