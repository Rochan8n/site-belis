...
export function CTASection() {
  ...
  const text = "FALE COM A PRODUTORA QUE REALMENTE ENTENDE DE NEGÓCIOS";
    ...
    <section ref={containerRef} className="relative w-full py-32 sm:py-48 bg-coral text-navy z-20 overflow-hidden">
      <div className="w-full px-6 sm:px-12 lg:px-24 flex flex-col items-center text-center">
        ...
        <button 
          ...
          className="group relative px-10 sm:px-16 py-6 sm:py-8 overflow-hidden bg-navy text-cream font-sans font-bold uppercase tracking-widest text-sm sm:text-base outline-none cursor-pointer transition-transform hover:scale-105 duration-300 rounded-sm"
        >
